    ...
    >
      <Card style={{ display: "flex", flexDirection: "row", width: "100%" }}>
        ...
        <Card.Body style={{ flex: 1, overflowY: "auto" }}>
          ...
          <Card.Text >
          I am Devansh Pandey, an employee at Oodles Technology, where I work as a backend developer and specialize in AI. 
          </Card.Text>
          <Card.Text>
          My role involves developing efficient backend systems and integrating cutting-edge AI solutions to enhance the functionality and performance of various applications. 
